...
# -p          -> Target port
# -s          -> Number of concurrent sockets to open simultaneously
# --sleeptime -> Seconds between sending an incomplete header line per socket, preventing the server from timing out the connection
